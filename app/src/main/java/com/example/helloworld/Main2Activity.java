    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnbinary5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editText1.setText(c);
                editText1.setText(Integer.toString(aa*1000000));
            }
        });
        ...
        btnbinary6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int aa = Integer.parseInt( c );
                editText1.setText(c);
                editText1.setText(Integer.toString(aa*100000));
            }
        });
        ...
        btnbinary7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int aa = Integer.parseInt( c );
                editText1.setText(c);
                editText1.setText(Integer.toString(aa*1000000000));
            }
        });
